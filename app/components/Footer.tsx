    ...
    <section className="footer-section">
      <div className="w-layout-blockcontainer main-container w-container">
        <div className="footer-container">
          <div className="footer-row">
            <a href="/" aria-current="page" className="footer-logo-wrapper w-inline-block w--current">
              <img src="https://cdn.prod.website-files.com/6543eed5397deb6f75475c49/6543eed5397deb6f75475c99_Saasdesk%20logo%20white.svg" loading="lazy" alt="" className="footer-logo" />
            </a>
            <a href="https://sasdesk.webflow.io/#Home" className="scroll-to-top-link w-inline-block">
            ...
            <div className="footer-app-links-wrapper">
              ...
              <a href="https://www.apple.com/in/app-store/" target="_blank" className="footer-app-link w-inline-block">
              ...
              <a href="https://play.google.com/" target="_blank" className="footer-app-link w-inline-block">
                <div className="header-app-embed w-embed">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="footer-columns-wrapper">
            <div className="footer-contact-and-social-links-wrapper">
              <div className="footer-links-container">
                ...
                <div className="animated-links-wrapper">
                  <a href="mailto:support@site.com" className="animated-link-block font-white w-inline-block">
                    <img src="https://cdn.prod.website-files.com/6507f776b9661ba4aa7204b4/653378e962589ce54acc6fd5_Vectors-Wrapper.svg" loading="lazy" width="41.26829147338867" height="36" alt="" className="link-icon" />
                  ...
                  <a href="tel:123-456-7890" className="animated-link-block font-white w-inline-block">
                    <img src="https://cdn.prod.website-files.com/6507f776b9661ba4aa7204b4/653378eb26923f878e6e2cb9_Vectors-Wrapper.svg" loading="lazy" width="41.53845977783203" height="36" alt="" className="link-icon" />
                    <div className="faq-link-text-wrapper">
            ...
            <div className="footer-content">
              <div id="w-node-_413552e3-8bdb-f177-44d9-7c96feed5b37-feed5b11" className="footer-column">
              ...
              <div className="footer-column">
                ...
                <a href="/template-info/license" className="footer-link">License</a>
      ...
      <div className="copyright-text-container">
        <div className="copyright-text-wrapper">
          <div className="body-small">© 2023 RNN Studio. All Rights Reserved.</div>
          <div className="body-small">Powered by <a href="https://webflow.com/" target="_blank" className="webflow-link">webflow</a></div>
        </div>
      </div>
    </section>
  );
