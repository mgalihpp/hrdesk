            ...
            <div className="pricing-tab-content w-tab-content">
              ...
              >
                <div className="pricing-columns-wrapper">
                  <div className="pricing-column">
                    ...
                    <div className="pricing-points-wrappper">
                      <div className="point-wrappper">
                        <img
                          loading="lazy"
                          src="https://cdn.prod.website-files.com/6543eed5397deb6f75475c49/6543eed5397deb6f75475c91_check.svg"
                          alt="check "
                  ...
                  <div className="pricing-column without-border">
                    <div className="pricing-row">
